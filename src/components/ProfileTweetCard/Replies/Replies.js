          ...
          <View style={styles.content}>
            <View style={styles.header}>
              <View style={styles.user}>
                ...
                <Text style={styles.dateText}>·14/2/20 </Text>
              </View>
              <ArrowIcon style={styles.arrowIcon} />
            </View>
            <View style={styles.tweetContainer}>
              <Text style={styles.tweet}>Must have icon collections</Text>
          ...
          <View style={styles.content}>
            <View style={styles.header}>
              <View style={styles.user}>
                ...
                <Text style={styles.username}>@kkuchka </Text>
                <Text style={styles.dateText}>·13/2/20 </Text>
              </View>
              <ArrowIcon style={styles.arrowIcon} />
            </View>
            <View style={styles.tweetContainer}>
              ...
              <Text style={styles.tweet}>
                Get it now on 👉 constructor.pixsellz.io
              </Text>
            </View>
            <View style={styles.footer}>
              <View style={styles.footerLeft}>
